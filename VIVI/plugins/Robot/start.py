...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAx0CXoHSygACLfVjG0tNDZ5tYot64fbw1UZrXdOQxAACzwUAAuICkVTOX2YMGLIvaykE")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/kakashi_bots_support) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
💖 sᴇᴀʀᴄʜ ᴩᴏᴡᴇʀᴇᴅ ʙʏ {config.MUSIC_BOT_NAME}"""
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/kakashi_bots_support"
                        ),
                    ],
                ]
            )
        ...
        if config.START_IMG_URL:
            try:
                await message.reply_sticker("CAACAgUAAx0CXoHSygACLfljG0vW8juMOldyXm95bw17qmG68QACnAYAAkySgFZRioys3VZzsR4E")
